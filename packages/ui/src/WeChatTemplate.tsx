...
const MOCK_CHATS = [
  { name: '产品小组', message: '好的，那我们就定这个配色方案了', time: '09:45', unread: 3, avatar: '👥' },
  { name: 'Lisa Chen', message: 'Preview 的链接我发你了～', time: '09:30', unread: 0, avatar: '👩‍💻' },
  { name: '设计资源', message: '本周灵感合集已更新', time: '昨天', unread: 1, avatar: '🎨' },
  { name: '周一的会议', message: '会议纪要：V2 功能优先级讨论', time: '昨天', unread: 0, avatar: '📋' },
...
export function WeChatTemplate({ palette }: WeChatTemplateProps) {
  const tokens = mapPaletteToTemplateTokens(palette.roles, 'wechat')
  ...
  return (
    ...
    >
      ...
      >
        {[
          { label: '微信', icon: 'M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5-5 5 5M12 15V5', active: true },
          { label: '通讯录', icon: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 7a4 4 0 1 0 0-8 4 4 0 0 0 0 8z', active: false },
          { label: '发现', icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z', active: false },
          { label: '我', icon: 'M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 7a4 4 0 1 0 0-8 4 4 0 0 0 0 8z', active: false },
        ].map((tab) => (
          <button
            key={tab.label}
            type="button"
            ...
            style={{
              color: tab.active ? 'var(--wt-accent)' : 'var(--wt-secondary-text)',
            }}
          >
